                        ...
                        <td>
                            <ul>
                                <li v-for="border in country.borders">
                                    <router-link :to="{name: 'details', params: {code:border}}">{{findCountry(border).name.common}}</router-link>
                                </li>
...
<script setup>
// esto se hace para poder obtener info de la URL
...
const findCountry = (code) => {
    // usamos el find para encontrar en la lista que tenemos de info de paises el que coincida con el url
